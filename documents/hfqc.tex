...
\abstract{Quasi-steller object (QSO) spectral templates are important both to QSO
  ...
  spectrum covers the full rest-frame range from Ly$\beta$ to 11000
  {\AA} without any significant host contamination. Assuming a power
  law continuum for the composite we find a spectral slope of $\alpha$
  = \textbf{1.72$\pm$0.01}, which is steeper than previously found in the
...
When investigating \textbf{dust in QSOs or in galaxies along QSO sightlines} dust in QSOs or in galaxies intervening QSO sightlines, template spectra can be used to determine the amount of
...
In central southern SDSS footprint, Stripe 82 \citep{Annis2014}, about 50 such candidate QSOs has been studied using the
...
suffice. \textbf{Of the 173 QSOs fulfilling the selection criteria, we have consequently selected 7 of the 102 SDSS QSOs with declinations} $\lesssim +15^\circ$ that are
...
optimal linear combination of templates among the model atmospheres \textbf{of the
...
\cite{Shen2011}, in which \textbf{the K-corrected, i-band magnitudes normalised at z = 2, $\mathrm{M_i (z=2)}$, } for the 105,783 quasars in DR7 \textbf{are}
