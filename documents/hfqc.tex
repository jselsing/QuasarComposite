...
\abstract{Quasi-stellar object (QSO) spectral templates are important both to QSO
  ...
  = 1.700$\pm$0.006}, which is steeper than previously found in the
  ...
  QSO composite spectrum to evaluate the reddening in other
  QSOs. }
...
variability. \textbf{The standard deviation of the constituent spectra as a function of
