...
Figure 1 in \cite{Shen2011} presents the distribution of M$_i(z=2)$ as a function redshift, for which the black dots represents about half of the objects and are uniformly selected to 90 percent completeness \citet{Richards2002a}. It is clear that our sample represents some of the brightest quasar between redshift 1 and 2. It is therefore potentially a biased subset of the parent quasar population. 
