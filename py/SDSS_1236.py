...
def main():
    ...
    mask = np.logical_and(wl_out > 14015, (wl_out < 14400))
    ...
    #Initial parameters
    init_vals = [1.08917200e-17,   1.56059111e+03,   1.84572636e+00]
    ...
    # ax.plot(wl, medfilt(flux, 3))
    #
    #
    # ax.plot(wl_fit, y_op)
    # ax.fill_between(wl_fit, y_op_lower, y_op_upper, alpha = 0.7)
    # pl.show()
    # # #Overplot lines
